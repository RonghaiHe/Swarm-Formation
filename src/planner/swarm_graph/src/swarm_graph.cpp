...
bool
SwarmGraph::updateGraph(const std::vector<Eigen::Vector3d>& swarm)
{
...
bool
SwarmGraph::setDesiredForm(const std::vector<Eigen::Vector3d>& swarm_des)
{
...
bool
SwarmGraph::calcMatrices(const std::vector<Eigen::Vector3d>& swarm, Eigen::MatrixXd& Adj, Eigen::VectorXd& Deg, Eigen::MatrixXd& SNL)
{
  //Init the matrices
...
double
SwarmGraph::calcDist2(const Eigen::Vector3d& v1, const Eigen::Vector3d& v2)
{
...
bool
SwarmGraph::calcFNorm2(double& cost)
{
...
bool
SwarmGraph::calcFGrad(Eigen::Vector3d& gradp, int idx)
{
  //Check if have the desired formation
  if (have_desired)
  {
...
bool
SwarmGraph::getGrad(std::vector<Eigen::Vector3d>& swarm_grad)
{
  if (have_desired)
  {
